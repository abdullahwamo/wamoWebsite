...
export const Contact: React.FC = () => {
  return (
    <section id='contact' className='py-16 bg-white text-black dark:bg-[#121212] dark:text-white animate-slideIn'>
      <div className='grid sm:grid-cols-2 items-start gap-16 p-4 mx-auto max-w-4xl bg-white dark:bg-[#121212] shadow-md shadow-orange-500 dark:shadow-orange-500 font-[sans-serif] rounded-lg'>
        <div>
          <h1 className='text-orange-500 text-3xl font-extrabold'>Lets Talk</h1>
          <p className='text-sm text-gray-500 mt-4'>
            Have some big idea or brand to develop and need help? Then reach out we would love to hear about your
